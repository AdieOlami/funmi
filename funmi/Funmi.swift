...
//  funmi
//
//  Created by Olar's Mac on 1/15/19.
//  Copyright © 2019 Adie Olami. All rights reserved.
//

import UIKit

public protocol FunmiDataSource: class {
    
    func funmiBackgroundColorFor(_ funmi: Funmi, atIndex index: Int) -> UIColor?
//    func swiftyOnboardNumberOfPages(_ funmi: Funmi) -> Int
//    func swiftyOnboardViewForBackground(_ funmi: Funmi) -> UIView?
//    func swiftyOnboardPageForIndex(_ funmi: Funmi, index: Int) -> SwiftyOnboardPage?
//    func swiftyOnboardViewForOverlay(_ funmi: Funmi) -> SwiftyOnboardOverlay?
//    func swiftyOnboardOverlayForPosition(_ funmi: SwiftyOnboard, overlay: SwiftyOnboardOverlay, for position: Double)
    
}

public class Funmi: UIView, UIScrollViewDelegate {
    
    open weak var dataSource: FunmiDataSource? {
        didSet {
            if let color = dataSource?.funmiBackgroundColorFor(self, atIndex: 0){
...
//public extension FunmiDataSource {
//
